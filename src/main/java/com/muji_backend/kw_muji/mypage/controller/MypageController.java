...
import com.muji_backend.kw_muji.mypage.dto.PasswordDTO;
...
public class MypageController {
    ...
    @PostMapping("/checkPw")
    public ResponseEntity<Map<String, Object>> enterUpdate(@AuthenticationPrincipal UserEntity userInfo, @RequestBody PasswordDTO dto) {
        try {
...
//    @PostMapping("/update")
//    public ResponseEntity<Map<String, Object>> updateUserInfo(@AuthenticationPrincipal UserEntity userInfo, @RequestBody UserInfoDTO dto) {
//        try {
//            final UserEntity updateUser =
//
//            return ResponseEntity.ok().body(Map.of("code", 200, "data", true));
//        } catch (IllegalArgumentException e) {
//            return ResponseEntity.badRequest().body(Map.of("code", 400, "data", e.getMessage()));
